...
export default function BrokenFieldsAlert({
  schema,
  baseId,
}: BrokenFieldsAlertProps) {
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1">
          ...
          <p className="text-xs text-blue-700 mb-3">
            {brokenFields.length} field{brokenFields.length !== 1 ? "s" : ""} in
            your Airtable base
            {brokenFields.length === 1 ? " has" : " have"} invalid configuration
            ...
            {brokenFields.map((field) => {
              ...
              return (
                <div
                  ...
                  className="bg-white rounded-md px-3 py-2 border border-blue-100"
                >
          ...
          <div className="mt-3 pt-3 border-t border-blue-200">
            <p className="text-xs text-blue-600">
              💡 These issues should be resolved in your Airtable base to ensure
