  ...
  return (
    <header className="text-center mb-12">
      ...
      <p className="text-xs text-gray-400 mt-4 max-w-lg mx-auto">
        Basemap does not collect, store any access tokens, base IDs, or personal information. All operations are performed directly in your browser, and no information is stored on the server.
      </p>
    </header>
  )
} 