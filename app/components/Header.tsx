  ...
  return (
    <header className="text-center mb-12">
      ...
      <p className="text-xs text-gray-400 mt-4 max-w-lg mx-auto">
        Basemap runs entirely in your browser. Your access tokens and data are used locally to make direct API calls to Airtable - nothing is ever sent through our servers.
      </p>
    </header>
  )
} 